...
def contact():
    mess._show(title='Contact with me', message="Contact on : 'Santonudevnath@gmail.com' ")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='File not found', message='Try again')
        window.destroy()
...
frame1 = tk.Frame(window, bg="#50c878")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#50c878")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Automatic Attendance System Using Face Recognition" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
head2 = tk.Label(frame2, text="                             Registrations                              ", fg="black",bg="#3ece48" ,font=('times', 17, ' bold ') )
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="black"  ,bg="gray"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
